...
```{r}
studios_counts <- as.numeric(table(unlist(p_data$studios)))
...
```
From the report, we all other pairs have significantly differenct average score from each other except for PG - Children-G - All Ages and R+ - Mild Nudity-G - All Ages pairs.
Based on the result and the boxplot above, the new column for rating was created in Data preprocessing Rmd.